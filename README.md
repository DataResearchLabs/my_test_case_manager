...
In the sample screenshot below, each value is displayed with a brief description of how to use each.<br>
<img align="left" src="img/img_07_status_values.png" width="792"><br>
<br>
