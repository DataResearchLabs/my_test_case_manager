...
* There is a **snapshot graph** on top depicting the test case counts for the latest release (R6 in our example below).<br>
* Below that is a **trend graph** showing test case results over time.<br>
<br>  
